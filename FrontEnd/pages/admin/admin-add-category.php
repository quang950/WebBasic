        ...
        <form id="addCategoryForm">
            <div class="form-group">
                ...
                <input 
                    ...
                    name="categoryName" 
                    required 
                    placeholder="Ví dụ: Toyota, Honda, BMW, Mercedes..."
                >
            </div>
            ...
            <div class="form-group">
                ...
                <textarea 
                    ...
                    placeholder="Nhập mô tả về loại xe này (không bắt buộc)..."
                ></textarea>
                <small>Mô tả ngắn gọn về thương hiệu xe này.</small>
            </div>
            ...
            <div class="form-group">
                <div class="checkbox-group">
                    <input 
                        ...
                        checked
                    >
                    <label for="categoryVisible">Hiển thị trên trang chủ</label>
                </div>
                <small>Bỏ chọn nếu muốn ẩn loại xe này khỏi trang chủ.</small>
            </div>
