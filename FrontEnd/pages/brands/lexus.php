        ...
        <div class="nav-links">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="lexus.php" class="active">Lexus</a>
          ...
          <div class="car-slider" style="margin: 0">
            ...
            >
              <div
                ...
                data-engine="2.0L"
                data-desc="Sedan hạng C cao cấp, êm ái và sang trọng."
              >
                <img src="../../assets/images/lexus-is300.jpg" alt="Lexus IS300" />
                <h3>Lexus IS300</h3>
                <p class="price">2.220.000.000 VNĐ</p>
              ...
              <div
                ...
                data-transmission="Tự động (AT)"
                data-engine="2.5L"
                data-desc="Sedan hạng E hạng sang, cực kỳ êm ái và tinh tế."
              >
      ...
      >
        <div>
          ...
          <p style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5)">
            Đại lý xe hơi uy tín, cung cấp các dòng xe chất lượng cao từ nhiều
        ...
        <div>
          ...
          <p style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5)">
            <i class="fas fa-envelope"></i> contact@3boysauto.vn
          </p>
          <p style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5)">
            <i class="fas fa-map-marker-alt"></i> 123 Đường ABC, TP.HCM
          </p>
        </div>
        <div>
          <h3
