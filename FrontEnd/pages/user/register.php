...
<head>
    ...
    <title>Đăng ký - 3 Boys Auto</title>
            ...
            <form action="#" method="POST" class="register-form" id="registerForm">
                ...
                <div class="form-group checkbox-group">
                    <label class="checkbox-label">
                        ...
                        Tôi đồng ý với <a href="#" onclick="showTerms()">Điều khoản sử dụng</a> và <a href="#" onclick="showPrivacy()">Chính sách bảo mật</a> của 3 Boys Auto
                    </label>
                </div>
                ...
                <div class="form-group checkbox-group">
                    <label class="checkbox-label">
                        ...
                        <span class="checkmark"></span>
                        Tôi muốn nhận thông tin khuyến mãi và tin tức mới nhất từ 3 Boys Auto
                    </label>
                </div>
    ...
    <div id="termsModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Bằng việc sử dụng website 3 Boys Auto, bạn đồng ý tuân thủ các điều khoản và điều kiện sử dụng được quy định dưới đây.</p>
                
                <h3>2. Sử dụng dịch vụ</h3>
                <p>Người dùng cam kết sử dụng website một cách hợp pháp, không vi phạm pháp luật Việt Nam và không làm tổn hại đến quyền lợi của các bên khác.</p>
                
                <h3>3. Thông tin sản phẩm</h3>
                <p>3 Boys Auto cam kết cung cấp thông tin sản phẩm chính xác nhất. Tuy nhiên, có thể có sai sót về kỹ thuật và chúng tôi có quyền điều chỉnh khi cần thiết.</p>
                
                <h3>4. Thanh toán và giao hàng</h3>
                <p>Khách hàng có trách nhiệm thanh toán đầy đủ theo thỏa thuận. Thời gian giao xe sẽ được thông báo cụ thể cho từng đơn hàng.</p>
                
                <h3>5. Bảo hành</h3>
                <p>Tất cả xe được bán tại 3 Boys Auto đều được bảo hành theo chính sách của hãng sản xuất.</p>
            </div>
        </div>
    </div>
    ...
    <div id="privacyModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Chúng tôi thu thập thông tin cá nhân khi bạn đăng ký tài khoản, đặt hàng hoặc liên hệ với chúng tôi.</p>
                
                <h3>2. Sử dụng thông tin</h3>
                <p>Thông tin của bạn được sử dụng để:</p>
                <ul>
                    <li>Xử lý đơn hàng và cung cấp dịch vụ</li>
                    <li>Liên hệ với bạn về đơn hàng</li>
                ...
                <p>Chúng tôi không bán, cho thuê hoặc chia sẻ thông tin cá nhân của bạn với bên thứ ba, trừ khi có yêu cầu từ cơ quan pháp luật.</p>
                
                <h3>5. Quyền của người dùng</h3>
                <p>Bạn có quyền yêu cầu truy cập, chỉnh sửa hoặc xóa thông tin cá nhân của mình bất cứ lúc nào.</p>
            </div>
        </div>
    </div>
